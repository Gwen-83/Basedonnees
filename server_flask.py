...
def clean_old_data():
    ...
    with open(CSV_FILE, "w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(header)  # Réécriture de l'en-tête
        writer.writerows(new_rows)

@app.before_request
def before_request():
    clean_old_data()  # Nettoyage automatique avant chaque requête
...
def receive_data():
    ...
    if 'data' in data:
        ...
        # Ajout de la donnée avec un timestamp dans le CSV
